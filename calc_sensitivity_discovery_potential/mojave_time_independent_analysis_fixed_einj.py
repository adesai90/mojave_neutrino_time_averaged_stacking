...
ednde=tr.to_dNdE(disc['n_sig'], E0=pivot_energy, unit=1e3)
ednde_err=tr.to_dNdE(disc['n_sig_error'], E0=pivot_energy, unit=1e3)
e2dnde=tr.to_E2dNdE(disc['n_sig'], E0=pivot_energy, unit=1e3)
e2dnde_err=tr.to_E2dNdE(disc['n_sig_error'], E0=pivot_energy, unit=1e3)
